...
export default function BookingPriceHeader({ tour }: BookingPriceHeaderProps) {
  ...
  return (
    <div className="relative -mx-5 -mt-5 mb-5 overflow-hidden border-b border-gray-100 px-5 pb-5 pt-5">
      {hasDiscount && (
        <div className="absolute right-0 top-0 rounded-bl-[1.5rem] bg-red-500 px-5 py-2 text-right text-white shadow-sm">
