...
- **คืนนี้ (พุธ):** Backend แก้ Auth 3 จุด + Frontend ทำ ProtectedRoute ได้เลย (ไม่ต้องรอกัน)
- **พฤหัสเช้า-เที่ยง:** Backend ส่ง Booking API ให้ Frontend ใช้ได้
- **พฤหัสบ่าย:** Frontend เชื่อม Booking page กับ API
- **พฤหัส 17:00-20:00:** QA ทดสอบ Auth + Booking ทั้ง API และหน้าเว็บ
